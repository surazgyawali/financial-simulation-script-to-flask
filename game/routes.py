...
def gameStart():
    if request.method == 'POST':
        ...
        while response != 12:
            if response == 1:
                return redirect('/hire-fire')

            elif response == 2:
                return redirect('/platform-income-statement')

            elif response == 3:
                return redirect('/platform-balance-sheet')

            elif response == 4:
                return redirect('/platform-cashflow-statement')

            elif response == 5:
                return redirect('/loan-performance')

            elif response == 6:
                return redirect('/loan-buyer-cash')

            elif response == 7:
                return redirect('/sell-loans')

            elif response == 8:
                return redirect('/securitize-loans')

            elif response == 9:
                return redirect('/sell-into-credit-facility')

            elif response == 10:
                return "TODO: Wil be here soon."

            elif response == 11:
                return redirect('/credit-facility-info')

            elif response == 13:
                return flask.redirect('/quit')
        return redirect('/next-quarter')
...
@app.route('/platform-income-statement')
def platformIncomeStatement():
...
@app.route('/platform-balance-sheet')
def platformBalanceSheet():
...
@app.route('/platform-cashflow-statement')
def platformCashflowStatement():
...
@app.route('/sell-into-credit-facility')
def sellIntoCreditFacility():
...
@app.route('/credit-facility-info')
def creditFacilityInfo():
